...
public:
    PointCloudViewer(int width, int height, float max_range_m, float zoom_factor, std::string output_dir);
    ~PointCloudViewer();
...
private:
    ...
    bool isInsideViewport(int x, int y) const;
    float visibleRangeM() const;
